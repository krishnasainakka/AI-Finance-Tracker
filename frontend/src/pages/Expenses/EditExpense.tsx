...
// const EditExpense: React.FC<EditExpenseProps> = ({ expenseInfo, budgetId, userId, refreshData }) => {
...
//     setAccountId(expenseInfo.accountId);
//     setAccountName(expenseInfo.accountName);
//     setBudgetId(expenseInfo.category); // Assuming 'category' holds budgetId
//     setDate(expenseInfo.date ? new Date(expenseInfo.date) : undefined);
//     setIsRecurring(expenseInfo.recurring);
//     setRecurringPeriod(expenseInfo?.recurringPeriod);
//   }
// }, [expenseInfo]);
...
//           onValueChange={(value) => {
//             // console.log("Selected recurringPeriod:", value);
